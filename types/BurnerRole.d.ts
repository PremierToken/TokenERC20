...
interface BurnerRoleInterface extends Interface {
  functions: {
...
export class BurnerRole extends Contract {
  connect(signerOrProvider: Signer | Provider | string): BurnerRole;
  attach(addressOrName: string): BurnerRole;
  deployed(): Promise<BurnerRole>;

  on(event: EventFilter | string, listener: Listener): BurnerRole;
  once(event: EventFilter | string, listener: Listener): BurnerRole;
  addListener(eventName: EventFilter | string, listener: Listener): BurnerRole;
  removeAllListeners(eventName: EventFilter | string): BurnerRole;
  removeListener(eventName: any, listener: Listener): BurnerRole;
